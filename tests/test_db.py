...
def test_get_close_db(app):
    ...
    # this tests that the db has closed after use in the app context
...
#the init-db command should call the init-db function and output a message
def test_init_db_command(runner, monkeypatch):
    ''' 
        ...
        The runner fixture in conftest.py is used to call init-db command by name.
    '''
